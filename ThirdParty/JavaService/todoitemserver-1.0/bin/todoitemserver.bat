@REM todoitemserver launcher script
@REM
@REM Envioronment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM TODOITEMSERVER_config.txt found in the TODOITEMSERVER_HOME.
@setlocal enabledelayedexpansion

@echo off
if "%TODOITEMSERVER_HOME%"=="" set "TODOITEMSERVER_HOME=%~dp0\\.."
set ERROR_CODE=0

set "APP_LIB_DIR=%TODOITEMSERVER_HOME%\lib\"
...
set "CFG_FILE=%TODOITEMSERVER_HOME%\TODOITEMSERVER_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running todoitemserver.
  echo.
